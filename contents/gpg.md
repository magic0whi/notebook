...
> In 2024, GnuPG 2.4.1 defaults to ECC algorithm (9) and Curve 25519 for ECC, which is modern and safe, I recommend using these defaults directly.
...
gpg --armor --export-secret-keys 42E49B284C30A0DA! > ryan4yin.primary.priv.asc

# Check the exported primary key's detail info,
nix run nixpkgs#pgpdump ryan4yin.primary.priv.asc
...
...
age --passphrase -o ryan4yin.primary.priv.asc.age ryan4yin.primary.priv.asc
rm ryan4yin.primary.priv.asc
```
...
age --passphrase  -o ryan4yin-gpg-subkeys.priv.age ryan4yin.authsub.priv.asc
rm ryan4yin.authsub.priv.asc
```
...
age --decrypt -o ryan4yin.primary.priv.asc ryan4yin.primary.priv.asc.age
